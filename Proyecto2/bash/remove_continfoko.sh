#!/bin/bash
# filepath: /home/juan-pablo/Escritorio/Uni/SOPES1/202109705_LAB_SO1_2S2025/Proyecto2/bash/remove_continfoko.sh

MODULE_NAME="continfo"  # Este es el nombre real del módulo cargado
PROC_FILE="continfo_so1_202109705"  # Este es el nombre del archivo en /proc

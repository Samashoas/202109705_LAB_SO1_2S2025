...
func (x *WeatherRequest) GetMunicipality() string {
	if x != nil {
...
func (x *WeatherRequest) GetTemperature() int32 {
	if x != nil {
...
func (x *WeatherRequest) GetHumidity() int32 {
	if x != nil {
		return x.Humidity
	}
	return 0
...
const file_proto_weather_proto_rawDesc = "" +
	"\n" +
	"\x13proto/weather.proto\x12\aweather\"\x8c\x01\n" +
	...
	"\aweather\x18\x04 \x01(\tR\aweather\"E\n" +
	"\x0fWeatherResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess2U\n" +
	"\x0eWeatherService\x12C\n" +
	"\x0eProcessWeather\x12\x17.weather.WeatherRequest\x1a\x18.weather.WeatherResponseB\tZ\a./protob\x06proto3"
...
var file_proto_weather_proto_depIdxs = []int32{
	0, // 0: weather.WeatherService.ProcessWeather:input_type -> weather.WeatherRequest
	1, // 1: weather.WeatherService.ProcessWeather:output_type -> weather.WeatherResponse
